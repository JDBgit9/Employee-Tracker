...
const promptMessages = {
	...
	viewManager: "View Employees By Manager",
...
async function addEmployee() {
	...
	connection.query('SELECT role.id, role.title FROM role ORDER BY role.id;', async (err, res) => {
		...
		connection.query('SELECT * FROM employee', async (err, res) => {
			...
			console.log('Employee has been added. Please view employee to verify...');
			connection.query(
...
function remove(input) {
	const promptQ = {
		yes: "yes",
		no: "no I don't (view employees on the main option)"
	};
	inquirer.prompt([
		{
			name: "action",
			type: "list",
			message: "In order to proceed an employee, an ID must be entered. View employees to get" +
